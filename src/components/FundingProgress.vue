...
<script>
const passPhrase = "wheel approve cricket spike vote pave unable cash whip cabin punch burden razor normal buyer security control satoshi width festival enact ginger twin abstract category";
